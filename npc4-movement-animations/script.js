...
class Enemy {
  constructor() {
    ...
    this.interval = Math.floor(Math.random() * 200 + 50); // each enemy can move at their own rythmn
  }
  update() {
    ...
    let dx = this.x - this.newX;// setting new coordinates for the enemies to travel to
